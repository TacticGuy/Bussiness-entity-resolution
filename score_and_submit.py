...
def sweep_thresholds(val_df, model, ground_truth_path, thresholds=None, all_s1_ids=None):
...
def main():
    ...
    parser.add_argument("--train-source1", default="dataset/train/train_source1.tsv")
    ...
    if args.threshold is not None:
        ...
        best_t, _, _ = sweep_thresholds(val_df, model, args.train_ground_truth,
                        all_s1_ids=pd.read_csv(args.train_source1, sep="\t", dtype=str)["entity_id"].tolist())
